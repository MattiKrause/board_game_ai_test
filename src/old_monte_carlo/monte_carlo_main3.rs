...
#[allow(dead_code)]
pub struct MonteCarloStrategyV3<WRF: WinReducerFactory> {
...
impl WinReward {
    pub fn new(tie: f64, win: f64, lose: f64) -> Self {
        Self {
            on_tie: (tie, tie),
            on_win: (win, lose)
        }
...
impl<G: MonteCarloGame + 'static, W: WinReducerFactory> GameStrategy<G> for MonteCarloStrategyV3<W> {
